...
<body>
    ...
    <div class="app-container">
        ...
        <nav class="side-menu" id="mySidebar">
            ...
            <div class="menu-item">
                <div class="menu-head dashboard" onclick="window.location.href='shopping.php';">
                    <i class="fas fa-shopping-cart"></i>Shopping
                </div>
            </div>

            <div class="menu-item">
                <div class="menu-head dashboard" onclick="window.location.href='music.php';">
                    <i class="fas fa-music"></i>Music
                </div>
            </div>

            <div class="menu-item">
                <div class="menu-head dashboard" onclick="window.location.href='film.php';">
            ...
            <div class="menu-item">
                ...
                <ul class="submenu" id="more-menu">
                    ...
                    <li><a href="courses.php"><i class="fas fa-book-open"></i><span>Courses</span></a></li>
                    ...
                    <li><a href="#playables"><i class="fas fa-gamepad"></i><span>Playables</span></a></li>
                </ul>
